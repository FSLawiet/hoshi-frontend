import { Enderecos, Usuarios } from "../../@types/usuarios";
import { CardEndereco } from "./CardEndereco";
import "./CheckoutEnvio.css";

export interface CheckoutEnvioProps {
  usuario: Usuarios;
  handleAdressChange: (event: React.FormEvent<HTMLInputElement>) => void;
  handleObsChange: (event: React.FormEvent<HTMLTextAreaElement>) => void;
  handleFormaPagamentoChange: (
    event: React.FormEvent<HTMLInputElement>
  ) => void;
}

export const CheckoutEnvio = ({
  usuario,
  handleAdressChange,
  handleObsChange,
  handleFormaPagamentoChange,
    ...
    <section id="envio">
      ...
      <details>
        ...
        <div id="endereco_cont">
          {usuario.enderecos.map((endereco: Enderecos, i: number) => (
            <CardEndereco
              endereco={endereco}
